...
export function FavoritesAndRecents({ lang, onSelect }: Props) {
  ...
  return (
    <Card className="border-trackline bg-platform rounded-[20px] border shadow-sm">
      <CardHeader className="border-trackline flex flex-row items-center justify-between gap-3 border-b pb-4">
