...
describe('MicroCache (cache/micro-cache)', () => {
  ...
  describe('getStale fallback', () => {
    ...
    it('returns value within maxStaleAgeMs past expiry', () => {
      cache.set('key', 'value')
    ...
    it('returns undefined when older than maxStaleAgeMs past expiry', () => {
      cache.set('key', 'value')
      vi.advanceTimersByTime(7000) // TTL + 6000ms > maxStaleAgeMs of 5000
  ...
  describe('evictOldest when maxSize reached', () => {
    ...
    it('evicts ~20% of entries for larger maxSize', () => {
