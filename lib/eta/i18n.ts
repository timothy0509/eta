...
const common: Record<string, TranslationEntry> = {
  ...
  operatorAll: { en: 'All', tc: '全部', sc: '全部' },
...
const kmb: Record<string, TranslationEntry> = {
  ...
  searchBusRoutes: { en: 'Search bus routes', tc: '搜尋巴士路線', sc: '搜索巴士路线' },
  clearSearch: { en: 'Clear search', tc: '清除搜尋', sc: '清除搜索' },
  clearFilters: { en: 'Clear search and filters', tc: '清除搜尋及篩選', sc: '清除搜索及筛选' },
  routesFound: { en: '{count} routes', tc: '{count} 條路線', sc: '{count} 条路线' },
  noRoutesMatch: {
    en: 'No routes match "{query}".',
    tc: '沒有符合「{query}」的路線。',
    sc: '没有符合“{query}”的路线。',
  },
  via: { en: 'Via', tc: '途經', sc: '途经' },
...
const lrt: Record<string, TranslationEntry> = {
  ...
  noScheduledTrains: {
    en: 'No scheduled trains',
    tc: '暫時沒有預定班次',
    sc: '暂时没有预定班次',
  },
  trainOrder1: { en: '1st', tc: '第1班', sc: '第1班' },
  trainOrder2: { en: '2nd', tc: '第2班', sc: '第2班' },
  trainOrder3: { en: '3rd', tc: '第3班', sc: '第3班' },
  trainOrderN: { en: '{seq}th', tc: '第{seq}班', sc: '第{seq}班' },
